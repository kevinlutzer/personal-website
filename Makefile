...
start-server:
	cd server && ENV=prod RATE_LIMIT=1000 DB_PASSWORD=password DB_USER=personalwebsite DB_NAME=personalwebsite DB_HOST=localhost DB_PORT=5432 DB_SSL_MODE=disable PORT=8080 STATIC_DIR=../public go run ./cmd/main.go ./cmd/env.go ./cmd/errors.go
