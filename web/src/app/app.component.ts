...
export class AppComponent {
  constructor(
    ...
    this.registry.addSvgIcon('medium-black', this.sanitizer.bypassSecurityTrustResourceUrl('assets/icons/medium-black.svg'));
    ...
    this.registry.addSvgIcon('medium-white', this.sanitizer.bypassSecurityTrustResourceUrl('assets/icons/medium-white.svg'));
  }
}
